import { Card, CardHeader, Grid2, IconButton, InputBase, Paper, Link, CircularProgress, Stack } from "@mui/material";
      ...
      <Grid2 container spacing={2} mt={2}>
        ...
        <Grid2 key={item.position} size={{ xs: 12, sm: 12, md: 4, lg: 4 }}>
          <Card sx={{ p: 1 }}>
            ...
            <Link href={item.link} target="_blank" sx={{ bgcolor: "#eaeaea", width: "100%", display: "inline-block", p: 2, borderRadius: 2, overflow: "auto" }}>{item.link}</Link>
          </Card>
        </Grid2>
        ))}
      </Grid2>
