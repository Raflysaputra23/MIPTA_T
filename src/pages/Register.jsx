...
import { Authentication, daftarWithManual } from "../server/auth";
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        variant="standard"
        minLength={4} 
        helperText={(!!username && username.length < 4) ? "Minimal 4 huruf" : (!!username) ? "Mantap" : "Masukkan username" }
      ...
      <TextField
        ...
        name="email"
        variant="standard"
        helperText={helperEmail ? "Masukkan email valid" : (!!email) ? "Mantap" : "Masukkan email"}
        error={helperEmail}
        value={email}
        required
        fullWidth
      ...
      <TextField
        ...
        name="password"
        variant="standard"
        helperText={(!!password && password.length < 6) ? "Minimal 6 huruf" : (!!password) ? "Mantap" : "Masukkan password" }
      ...
      <TextField
        ...
        name="password2"
        variant="standard"
        helperText={(!!password2 && password2.length < 6) ? "Minimal 6 huruf" : (!!password2) ? "Mantap" : "Masukkan password" }
